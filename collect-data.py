...
while True:
    ...
    cv2.putText(frame, "j : "+str(count['j']), (100, 185), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
    ...
    cv2.putText(frame, "None : " + str(count['None']), (10, 350), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    ...
    th3 = cv2.adaptiveThreshold(blur,120,cv2.ADAPTIVE_THRESH_GAUSSIAN_C,cv2.THRESH_BINARY_INV,11,2)
